...
function Footer() {
  return (
    <div>
      ...
      <footer className="footer footer-center p-10 bg-black-90 dark:bg-slate-900 dark:text-black text-white-800 rounded-lg shadow-md">
        <nav className="grid grid-flow-col gap-8 text-lg font-semibold">
          <Link
            to="/about"
        ...
        <aside className="mt-6 text-sm font-medium text-gray-500 dark:text-gray-400">
